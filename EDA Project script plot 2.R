...
plot2<-plot(shpc$Global_active_power~shpc$Datetime,type="l", ylab="Global Active Power (kilowatts)", xlab="")

png(filename="~/Coursera/2025/Modulo 4/week 1 - module 1/Project 1 module 4/plot2.png")
